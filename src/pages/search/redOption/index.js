...
const redOptionComponent = ({ redOption, dispatch }) => {
  const { productList, shifList, areaList, lineList, redList } = redOption;
  ...
  const query = async (params, sorter, filter) => {
    const TableList = postListInit({
      ...
      type:
        params.type == "" || params.type == undefined ? "" : "T" + params.type,
