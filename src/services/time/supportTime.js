...
export async function postListInit(params) {
  return request(`${ip}/WebAPI/api/TimeSupportDept/List`, {
    method: 'POST',
    data: { ...params },
  });
}
...
//获取红色动态项
 export async function ListDowntimeCol(params) {
  return request(`${ip}/WebAPI/api/TimeSupportDept/ListDowntimeCol`, {
    method: 'POST',
    data: { ...params },
  });
}
...
export async function addPost(params) {
  return request(`${ip}/WebAPI/api/TimeSupportDept/Add`, {
    method: 'POST',
    data: { ...params },
  });
}
...
export async function updatePut(params) {
  return request(`${ip}/WebAPI/api/TimeSupportDept/Modify`, {
    method: 'POST',
    data: { ...params },
  });
}
...
export async function deleted(params) {
  return request(`${ip}/WebAPI/api/TimeSupportDept/Delete`, {
    method: 'POST',
    data: { ...params },
  });
}
