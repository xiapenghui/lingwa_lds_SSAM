...
// 休假选项接口
export async function getRelaxtype(params) {
  return request(`${ip}/WebAPI/api/Common/GetRelaxtypeIdText`, {
    method: 'POST',
    data: { ...params }
  });
}
...
export async function postListInit(params) {
  return request(`${ip}/WebAPI/api/TimeDailyShift/List`, {
    method: 'POST',
    data: { ...params },
  });
}
...
//提前排班
export async function PrevDailyShift(params) {
  return request(`${ip}/WebAPI/api/TimeDailyShift/PrevDailyShift`, {
    method: 'POST',
    data: { ...params },
  });
}
