...
export async function postListInit(params) {
  return request(`${ip}/WebAPI/api/KpiAreasShift/List`, {
    method: 'POST',
    data: { ...params },
  });
}
...
export async function addPost(params) {
  return request(`${ip}/WebAPI/api/KpiAreasShift/Add`, {
    method: 'POST',
    data: { ...params },
  });
}
...
export async function updatePut(params) {
  return request(`${ip}/WebAPI/api/KpiAreasShift/Modify`, {
    method: 'POST',
    data: { ...params },
  });
}
...
export async function deleted(params) {
  return request(`${ip}/WebAPI/api/KpiAreasShift/Delete`, {
    method: 'POST',
    data: { ...params },
  });
}
